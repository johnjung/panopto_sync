...
class PanoptoOAuth2():
    def __init__(self, server, client_id, client_secret, ssl_verify, verbose):
        self.server = server
        ...
        self.authorization_endpoint = 'https://{}/Panopto/oauth2/connect/authorize'.format(self.server)
        self.access_token_endpoint = 'https://{}/Panopto/oauth2/connect/token'.format(self.server)
        self.cache_file = 'token_{}_{}.cache'.format(self.server, self.client_id)
